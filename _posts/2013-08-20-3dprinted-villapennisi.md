...
The team gave me the honour to design the lamp to be used by pianist Mº Campanella during the evening concert.
I received advice by Lighting Designer Filippo Cannata on how to modulate the light correctly to avoid glaring effects and illuminate only the piano keyboard and the music sheet. I have used grasshopper in Rhino to model the final shape which is also inspired by the name of the maestro: Campanella in Italian means "Little Bell" and the lamp adopts the profiles of a Bell.
We applied holes on the above layer, closer to the light to avoid overheating of the PLA material, use to 3D print the parts.
